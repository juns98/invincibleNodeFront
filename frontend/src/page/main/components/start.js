...
import stakeAmountReducer, { selectStakeAmount } from "../../../redux/reducers/stakeAmountReducer";
...
const Start = () => {
    ...
    return(
        <>
            <StartButton onClick={() => {doStake(stakeAmountRedux)}}>Start Invincible Stake</StartButton>
        </>
    );
}
